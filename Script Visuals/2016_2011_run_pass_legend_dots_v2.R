...
ggplot() + geom_point(data = by_ydline, aes(x=ABS.Yardline, y=raw_ep,color="Points_2016") ) + 
  ...
  ggtitle("2011/2016 NFL Expected Points") + labs(x="Yard Line", y="Expected Points") +geom_line(aes( x, y, linetype = Negative_EP ), Negative_EP, size=1.3) +theme(plot.title = element_text(hjust = 0.5))
